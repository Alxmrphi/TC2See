...
sys.path.append("D:/fmri_processing")

from fmri_processing.preprocessing import convert_dicom, copy_nii_to_project, process_tsv_files

tmp_folder = "D:/fmri_processing/results/__tmp3__"
output_folder = "D:/fmri_processing/results"

project = "TC2See"
sub = "24"

base_folder = f"D:/fmri_processing/data/{project}_{sub}"
