...
class Data:
    def __init__(self, project, subject, task, run, space="MNI152NLin2009cAsym"):
        ...
        self.layout = bids.BIDSLayout(Path("../results") / project)
        self.layout2 = bids.BIDSLayout(Path("../results") / ("derivatives_" + project), False)
